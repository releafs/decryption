...
# Function to fetch the processed result file from GitHub
def fetch_processed_result(retries=30, initial_delay=60, subsequent_delay=30):
    headers = {
    ...
    st.write(f"Waiting for {initial_delay} seconds before fetching the result...")
...
# Streamlit App
st.title("Releafs Token Results")

st.markdown("""
Your Releafs Token empowers real-world climate action. 
Track your token to discover the tangible, positive impact you're contributing to.
""")
